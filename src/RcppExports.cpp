...
FLQuantAD test_operatingModel_eval_target(FLFisheriesAD flfs, SEXP flbs_list_sexp, const fwdControl ctrl, const int target_no, const int sim_target_no);
RcppExport SEXP FLasher_test_operatingModel_eval_target(SEXP flfsSEXP, SEXP flbs_list_sexpSEXP, SEXP ctrlSEXP, SEXP target_noSEXP, SEXP sim_target_noSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< FLFisheriesAD >::type flfs(flfsSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type target_no(target_noSEXP);
    Rcpp::traits::input_parameter< const int >::type sim_target_no(sim_target_noSEXP);
    __result = Rcpp::wrap(test_operatingModel_eval_target(flfs, flbs_list_sexp, ctrl, target_no, sim_target_no));
    return __result;
END_RCPP
}
