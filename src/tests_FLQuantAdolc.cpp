...
/*
// [[Rcpp::export]]
std::vector<double> test_FLQuantAD_get_data(FLQuantAD flq){
	return flq.get_data();
}
*/
...
/*
// [[Rcpp::export]]
FLQuantAD test_FLQuantAD_set_data(FLQuantAD flq, std::vector<double> data_in){
