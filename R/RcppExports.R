...
test_operatingModel_load_ad_members_year_season <- function(flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, year, season) {
    .Call('FLasher_test_operatingModel_load_ad_members_year_season', PACKAGE = 'FLasher', flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, year, season)
}

test_operatingModel_load_ad_members_timestep <- function(flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, timestep) {
    .Call('FLasher_test_operatingModel_load_ad_members_timestep', PACKAGE = 'FLasher', flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, timestep)
}

test_operatingModel_update_from_ad_members_year_season <- function(flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, year, season) {
    .Call('FLasher_test_operatingModel_update_from_ad_members_year_season', PACKAGE = 'FLasher', flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, year, season)
}

test_operatingModel_update_from_ad_members_timestep <- function(flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, timestep) {
    .Call('FLasher_test_operatingModel_update_from_ad_members_timestep', PACKAGE = 'FLasher', flfs, flb_sexp, model_name, params, timelag, residuals, residuals_mult, f, f_spwn, ctrl, timestep)
}
