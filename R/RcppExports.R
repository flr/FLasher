...
test_operatingModel_F_FCB <- function(flfs, flbs_list_sexp, ctrl, fishery_no, catch_no, biol_no) {
    .Call('FLasher_test_operatingModel_F_FCB', PACKAGE = 'FLasher', flfs, flbs_list_sexp, ctrl, fishery_no, catch_no, biol_no)
}
