...
Set up the stock object for the projections:
...
flash_ctrl@trgtArray <- new_trgtArray
flash_mtf <- FLash::fwd(ple4p_mtf, flash_ctrl, sr = list(model = model, params=params(ple4.sr)), sr.residuals=residuals, sr.residuals.mult=TRUE)
