...
\title{FLasher\\Multi-species, multi-fishery projections with FLR\\User maual}
...
%
%This document is the user manual for \pkg{FLasher}.
%It is structured around examples which also acts as tests.
%
%
...
%
%\section{Multi-fishery example}
%
%\section{Multi-species, multi-fishery example}
%
%\section{Example with a seasonal time step}
