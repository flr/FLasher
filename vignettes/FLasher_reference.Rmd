...
This document focuses on the details of the projection methods of the *FLasher* package. These are implemented in C++ using __RCpp__ amd __CppAD__.
...
The biological stocks in the operating model are stored as an object of class **fwdBiols**.
This is a list of the stocks, each stored as an **fwdBiol** object (analagous to the **FLBiol** class in R).
...
A Fishery may have only a single Catch, i.e. it only catches from one biological stock.
