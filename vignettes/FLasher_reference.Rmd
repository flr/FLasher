...
The final step in calculating recruitment is the application of deviances.
This is an additional multiplier applied to the calculated recruitment.
The deviances can be used to introduce further uncertainty on the recruitment. 

The deviances are stored as an **FLQuant**. Internally, this must have the same time dimensions as the model.
However, the R method *fwd()* accepts deviances just for the projection years.
The first dimension of the deviances is length 1.
